...
//
//    public BaseDistributedLock(ZooKeeper zooKeeper, String path, String lockName) {
...
//     * 创建临时顺序节点
//     *
//     * @param zooKeeper Zookeeper客户端
//     * @param path      节点路径
//     * @return
//     * @throws Exception
//     */
//    private String createEphemeralSequential(ZooKeeper zooKeeper, String path) throws Exception {
//        return zooKeeper.create(path, "write".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL);
//        ;
//    }
//
//    /**
