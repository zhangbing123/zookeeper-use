...
//
//        log.info("start init order server ....");
//        InetAddress address = InetAddress.getLocalHost();
//
//        ResouceUsage orderServer = new ResouceUsage("orderServer", 20, 20, 20, address.getHostAddress());
//
...
//        }
//
//        log.info("create a ephemeral_sequential node of order server to zookeeper and report machine resource usage");
//        String path = CLUSTERMANAGE_ROOT + "/order";
